...
Route::get('/datatable/routes', 'DatatableController@routes')->name('datatable.routes');
Route::get('/datatable/supervisor_agent', 'DatatableController@supervisor_agent')->name('datatable.supervisor_agent');
Route::get('/datatable/supervisor_close', 'DatatableController@supervisor_close')->name('datatable.supervisor_close');
Route::get('/datatable/supervisor_tracker', 'DatatableController@supervisor_tracker')->name('datatable.supervisor_tracker');
Route::get('/datatable/supervisor_statistics_agents', 'DatatableController@supervisor_statistics_agents')->name('datatable.supervisor_statistics_agents');